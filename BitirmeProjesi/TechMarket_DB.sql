...
CREATE TABLE Siparis (
    ...
    odeme_turu NVARCHAR(20) CHECK (odeme_turu IN ('Kredi Karti', 'Banka Karti', 'Havale', 'Kapida Odeme')) NOT NULL,
    siparis_durumu NVARCHAR(20) CHECK (siparis_durumu IN ('Beklemede', 'Onaylandi', 'Hazirlaniyor', 'Kargolandi', 'Teslim Edildi', 'Iptal')) DEFAULT 'Beklemede',
...
CREATE TABLE Kargo (
    ...
    teslim_tarihi DATE,
    durum NVARCHAR(20) CHECK (durum IN ('Hazirlaniyor', 'Kargoya Verildi', 'Dagitimda', 'Teslim Edildi')) DEFAULT 'Hazirlaniyor',
...
CREATE TABLE Iade (
    ...
    durum NVARCHAR(20) CHECK (durum IN ('Talep Edildi', 'Onaylandi', 'Reddedildi', 'Tamamlandi')) DEFAULT 'Talep Edildi',
...
CREATE TABLE Personel (
    ...
    soyad NVARCHAR(50) NOT NULL,
    email NVARCHAR(100) UNIQUE NOT NULL,
    rol NVARCHAR(30) CHECK (rol IN ('Admin', 'Yonetici', 'Satis', 'Depo', 'Musteri Hizmetleri')),
...
(N'Ahmet', N'Yilmaz', N'ahmet.yilmaz@email.com', N'05321234567', N'Istanbul', N'Kadikoy, Moda Cad. No:15', '1985-03-15', 250),
(N'Ayse', N'Demir', N'ayse.demir@email.com', N'05339876543', N'Ankara', N'Cankaya, Kizilay Mah. No:42', '1990-07-22', 180),
(N'Mehmet', N'Kaya', N'mehmet.kaya@email.com', N'05445556677', N'Izmir', N'Karsiyaka, Bostanli Sok. No:8', '1988-11-30', 420),
(N'Zeynep', N'Sahin', N'zeynep.sahin@email.com', N'05367778899', N'Bursa', N'Nilufer, Ataturk Cad. No:23', '1995-01-18', 95),
(N'Ali', N'Ozturk', N'ali.ozturk@email.com', N'05551112233', N'Antalya', N'Muratpasa, Lara Yolu No:67', '1982-09-05', 560),
(N'Fatma', N'Celik', N'fatma.celik@email.com', N'05423334455', N'Adana', N'Seyhan, Inonu Cad. No:12', '1992-04-12', 140),
(N'Can', N'Arslan', N'can.arslan@email.com', N'05398887766', N'Kocaeli', N'Izmit, Sehit Pamir Cad. No:34', '1987-06-28', 310),
(N'Elif', N'Yildiz', N'elif.yildiz@email.com', N'05334445566', N'Konya', N'Selcuklu, Mevlana Cad. No:56', '1993-12-03', 75);
GO

-- 2. Markalar
INSERT INTO Marka (ad, aciklama) VALUES
(N'Apple', N'Teknoloji ve elektronik urunleri'),
(N'Samsung', N'Akilli telefon ve elektronik cihazlar'),
(N'LG', N'Ev elektronigi ve beyaz esya'),
(N'Sony', N'Oyun konsolu ve elektronik eglence sistemleri'),
(N'Dell', N'Bilgisayar ve is istasyonlari'),
(N'HP', N'Yazici ve bilgisayar ekipmanlari'),
(N'Lenovo', N'Dizustu bilgisayar ve tablet'),
(N'Asus', N'Bilgisayar bilesenleri ve oyun ekipmanlari'),
(N'Xiaomi', N'Akilli telefon ve akilli ev cihazlari'),
(N'Bose', N'Ses sistemleri ve kulakliklar'),
(N'JBL', N'Tasinabilir hoparlorler'),
(N'Logitech', N'Bilgisayar cevre birimleri'),
(N'Dyson', N'Elektrikli supurge ve ev aletleri'),
(N'Philips', N'Kucuk ev aletleri');
GO
...
(4, N'Beyaz Esya', NULL),
(5, N'Kucuk Ev Aletleri', NULL),
(6, N'Gaming', NULL),
(7, N'Dizustu Bilgisayar', 1),
(8, N'Masaustu Bilgisayar', 1),
(9, N'Tablet', 1),
(10, N'Akilli Telefon', 2),
(11, N'Kulaklik', 2),
(12, N'Sarj Cihazi', 2),
(13, N'Televizyon', 3),
(14, N'Hoparlor', 3),
(15, N'Buzdolabi', 4),
(16, N'Camasir Makinesi', 4),
(17, N'Elektrikli Supurge', 5),
(18, N'Blender', 5),
(19, N'Oyun Konsolu', 6),
(20, N'Oyun Kulakligi', 6);
...
(N'TechPlus Dagitim A.S.', N'Istanbul, Umraniye Organize Sanayi', N'02161234567', N'info@techplus.com'),
(N'Elektronik Toptan Ltd.', N'Ankara, Siteler Toptan Satis', N'03124567890', N'satis@elektroniktoptan.com'),
(N'Global Tech Import', N'Izmir, Bornova Sanayi', N'02325556677', N'destek@globaltech.com'),
(N'MegaTek Dagitim', N'Bursa, Organize Sanayi Bolgesi', N'02243334455', N'siparis@megatek.com');
GO
...
(N'LG Buzdolabi 600L', 28999.00, 24000.00, 8, 15, 4, 3, N'GC-B247SLUV', N'8697421234574', 24, 1),
...
(N'Samsung Camasir Makinesi 9KG', 12999.00, 10500.00, 10, 16, 4, 2, N'WW90', N'8697421234578', 24, 1),
(N'JBL Charge 5 Hoparlor', 3999.00, 3200.00, 50, 14, 2, 11, N'CHARGE5', N'8697421234579', 12, 1),
(N'Xiaomi Redmi Note 13', 8999.00, 7500.00, 45, 10, 2, 9, N'M2101K6G', N'8697421234580', 24, 1),
(N'HP LaserJet Yazici', 4999.00, 4000.00, 28, 8, 3, 6, N'M140w', N'8697421234581', 12, 1),
...
(4, N'Cozunurluk', N'4K QLED'),
(4, N'HDR', N'Evet'),
(5, N'Islemci', N'Intel Core i7-13700H'),
(5, N'RAM', N'16 GB'),
(5, N'SSD', N'512 GB'),
(5, N'Ekran Karti', N'NVIDIA RTX 4050'),
...
(N'Yilbasi Kampanyasi', N'Tum elektronik urunlerde %15 indirim', 15.00, '2024-12-20', '2025-01-05', 1),
(N'Telefon Festivali', N'Akilli telefonlarda ozel fiyatlar', 10.00, '2025-01-10', '2025-01-31', 1),
(N'Gaming Haftasi', N'Oyun ekipmanlarinda %20 indirim', 20.00, '2025-02-01', '2025-02-15', 0),
(N'Bahar Kampanyasi', N'Beyaz esyada buyuk firsatlar', 12.00, '2025-03-01', '2025-03-31', 0);
GO
...
(1, '2024-12-20 10:30:00', 55999.00, N'Kredi Karti', N'Teslim Edildi', 0.00, N'Kadikoy, Moda Cad. No:15, Istanbul'),
(2, '2024-12-22 14:20:00', 43999.00, N'Kredi Karti', N'Teslim Edildi', 0.00, N'Cankaya, Kizilay Mah. No:42, Ankara'),
(3, '2024-12-25 16:45:00', 25999.00, N'Banka Karti', N'Kargolandi', 0.00, N'Karsiyaka, Bostanli Sok. No:8, Izmir'),
(4, '2024-12-28 11:15:00', 12999.00, N'Havale', N'Onaylandi', 29.90, N'Nilufer, Ataturk Cad. No:23, Bursa'),
(5, '2025-01-02 09:30:00', 70998.00, N'Kredi Karti', N'Hazirlaniyor', 0.00, N'Muratpasa, Lara Yolu No:67, Antalya'),
(1, '2025-01-05 13:40:00', 14498.00, N'Kredi Karti', N'Beklemede', 0.00, N'Kadikoy, Moda Cad. No:15, Istanbul'),
(6, '2025-01-08 15:20:00', 8999.00, N'Kapida Odeme', N'Beklemede', 29.90, N'Seyhan, Inonu Cad. No:12, Adana'),
(7, '2025-01-10 10:00:00', 48999.00, N'Kredi Karti', N'Beklemede', 0.00, N'Izmit, Sehit Pamir Cad. No:34, Kocaeli');
GO
...
(2, N'Yurtici Kargo', N'YI987654321TR', '2024-12-23', '2024-12-25', N'Teslim Edildi'),
(3, N'MNG Kargo', N'MN456789123TR', '2024-12-26', NULL, N'Dagitimda'),
(4, N'Surat Kargo', N'SR789456123TR', '2024-12-29', NULL, N'Kargoya Verildi'),
(5, N'Aras Kargo', N'AR321654987TR', '2025-01-03', NULL, N'Hazirlaniyor');
GO

-- 12. Iade Kayitlari
INSERT INTO Iade (siparis_id, urun_id, iade_nedeni, iade_tarihi, durum, iade_tutari) VALUES
(2, 2, N'Urun hasarli geldi, klavyede sorun var', '2024-12-27', N'Tamamlandi', 42999.00),
(1, 13, N'Beklentimi karsilamadi, ses kalitesi dusuk', '2024-12-24', N'Onaylandi', 3999.00);
GO

-- 13. Urun Degerlendirmeleri
INSERT INTO Urun_Degerlendirme (urun_id, musteri_id, puan, yorum, onay_durumu) VALUES
(1, 1, 5, N'Harika bir telefon! Kamera kalitesi mukemmel, pil omru cok iyi.', 1),
(6, 5, 5, N'PlayStation 5 beklentilerimin uzerinde, oyunlar akici calisiyor.', 1),
(7, 3, 4, N'iPad guzel ama fiyati biraz yuksek. Performans olarak memnunum.', 1),
(9, 1, 5, N'Bose kulaklik harika! Gurultu engelleme ozelligi cok basarili.', 1),
(14, 6, 4, N'Xiaomi telefon fiyat/performans acisindan cok iyi. Tavsiye ederim.', 1),
(3, 8, 5, N'Samsung Galaxy S24 Ultra kamera ozellikleri inanilmaz!', 0),
(12, 4, 3, N'Camasir makinesi iyi calisiyor ama biraz gurultulu.', 1);
GO
...
(N'Kemal', N'Aydin', N'kemal.aydin@techmarket.com', N'Admin', N'$2y$10$abcdefgh...', 1, '2020-01-15'),
(N'Selin', N'Korkmaz', N'selin.korkmaz@techmarket.com', N'Yonetici', N'$2y$10$ijklmnop...', 1, '2021-03-20'),
(N'Burak', N'Tekin', N'burak.tekin@techmarket.com', N'Satis', N'$2y$10$qrstuvwx...', 1, '2022-06-10'),
(N'Merve', N'Ozkan', N'merve.ozkan@techmarket.com', N'Musteri Hizmetleri', N'$2y$10$yzabcdef...', 1, '2023-02-14'),
(N'Emre', N'Gunes', N'emre.gunes@techmarket.com', N'Depo', N'$2y$10$ghijklmn...', 1, '2023-08-05');
GO
...
VALUES 
(N'Deniz', N'Yilmaz', N'deniz.yilmaz@email.com', N'05551234567', N'Istanbul', N'Besiktas, Barbaros Bulvari No:45', '1991-05-20'),
(N'Cem', N'Akar', N'cem.akar@email.com', N'05449876543', N'Ankara', N'Kecioren, Etlik Cad. No:78', '1989-08-12'),
(N'Seda', N'Kilic', N'seda.kilic@email.com', N'05338887766', N'Izmir', N'Alsancak, Kibris Sehitleri Cad. No:23', '1994-03-07');
GO
...
VALUES (9, 55999.00, N'Kredi Karti', N'Beklemede', 0.00, N'Besiktas, Barbaros Bulvari No:45, Istanbul');
GO
...
VALUES (N'Subat Indirimleri', N'Tum laptop modellerinde %10 indirim', 10.00, '2025-02-01', '2025-02-28', 1);
GO
...
UPDATE Musteri 
SET telefon = N'05321111111', sehir = N'Canakkale' 
WHERE id = 1;
GO
...
UPDATE Siparis 
SET siparis_durumu = N'Onaylandi' 
WHERE id = 6;
GO

UPDATE Siparis 
SET siparis_durumu = N'Kargolandi' 
WHERE id = 4;
GO
...
SELECT TOP 5
    M.id,
    M.ad + N' ' + M.soyad AS [Musteri Adi],
    COUNT(S.id) AS [Toplam Siparis],
    SUM(S.toplam_tutar) AS [Toplam Harcama]
FROM Musteri M
INNER JOIN Siparis S ON M.id = S.musteri_id
GROUP BY M.id, M.ad, M.soyad
ORDER BY [Toplam Siparis] DESC, [Toplam Harcama] DESC; --Toplam siparise gore sýralanýyor fakat sayý ayný olursa da toplamharcamaya göre de sýralanýyor
GO
...
SELECT
    ...
    SUM(SD.satis_fiyati) AS [Toplam Satis Cirosu]
FROM Urun U
INNER JOIN Siparis_Detay SD ON U.id = SD.urun_id
INNER JOIN Marka M ON U.marka_id = M.id
INNER JOIN Kategori K ON U.kategori_id = K.id
GROUP BY U.id, U.ad, M.ad, K.ad, U.stok
ORDER BY [Toplam Satilan Adet] DESC, [Toplam Satis Cirosu] DESC;
GO
...
SELECT 
    ...
    ST.telefon,
    ST.email,
    COUNT(DISTINCT U.id) AS [Toplam Urun Sayisi],
    SUM(SD.adet) AS [Toplam Satilan Adet],
...
SELECT 
    K.ad AS Kategori,
    COUNT(DISTINCT U.id) AS [Urun Sayisi],
    SUM(SD.adet) AS [Toplam Satilan Adet],
    SUM(SD.satis_fiyati) AS [Toplam Satis Tutari],
    AVG(SD.satis_fiyati) AS [Ortalama Satis Fiyati],
...
SELECT 
    ...
    AVG(toplam_tutar) AS [Ortalama Sepet Tutari],
    MAX(toplam_tutar) AS [En Yuksek Siparis],
    MIN(toplam_tutar) AS [En Dusuk Siparis]
FROM Siparis
...
SELECT 
    S.id AS [Siparis ID],
    S.tarih AS [Siparis Tarihi],
    M.ad + N' ' + M.soyad AS [Müsteri Adi],
    M.sehir AS [Musteri Sehri],
    M.telefon AS [Musteri Telefon],
    U.ad AS [Urun Adi],
    MR.ad AS Marka,
    SD.adet,
    SD.satis_fiyati,
...
SELECT 
    ...
    M.sehir,
    M.kayit_tarihi,
    DATEDIFF(DAY, M.kayit_tarihi, GETDATE()) AS [Kayit Suresi Gun]
FROM Musteri M
...
SELECT  TOP 3
    K.id,
    K.ad AS Kategori,
    SUM(SD.satis_fiyati) AS [Toplam Satis],
...
SELECT 
    ...
    M.email,
    S.toplam_tutar,
    (SELECT AVG(toplam_tutar) FROM Siparis) AS [Ortalama Siparis Tutari],
    S.toplam_tutar - (SELECT AVG(toplam_tutar) FROM Siparis) AS [Ortalamanin Ustunde],
    (SELECT COUNT(*) FROM Siparis WHERE musteri_id = M.id) AS [Toplam Satis Sayisi]
FROM Siparis S
INNER JOIN Musteri M ON S.musteri_id = M.id
